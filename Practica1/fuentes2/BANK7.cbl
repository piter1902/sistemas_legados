       ...
       WAIT-ORDER.
           ...
           *>Se ha eliminado el AT LINE 24 COL 80
       ...
       SALDO-SUFICIENTE.
           ...
           DISPLAY "Compra de entradas de espectaculos" AT LINE 6 COL 22.
           DISPLAY "Vas a comprar    entradas" AT LINE 8 COL 15.
           DISPLAY USER-NUM-ENTRADAS AT LINE 8 COL 29.
       ...
       NO-ENTR-DISP.
           PERFORM IMPRIMIR-CABECERA THRU IMPRIMIR-CABECERA.
           DISPLAY "Compra de entradas de espectaculos" AT LINE 06 COL 22.
           DISPLAY "Lamentamos comunicarle que" AT LINE 08 COL 27
               WITH BACKGROUND-COLOR RED.
           DISPLAY "El espectaculo seleccionado no" AT LINE 9 COL 9
               WITH BACKGROUND-COLOR RED.
           DISPLAY "dispone de suficientes entradas" AT LINE 9 COL 40
               WITH BACKGROUND-COLOR RED.
           DISPLAY "Enter - Aceptar" AT LINE 24 COL 33.
       ...
       SALDO-INSUFICIENTE.
           PERFORM IMPRIMIR-CABECERA THRU IMPRIMIR-CABECERA.
           DISPLAY "Compra de entradas de espectaculos" AT LINE 6 COL 22.
           DISPLAY "Lamentamos comunicarle que" AT LINE 8 COL 27
               WITH BACKGROUND-COLOR RED.
           DISPLAY "su saldo es insuficiente" AT LINE 9 COL 28
               WITH BACKGROUND-COLOR RED.
           DISPLAY "Enter - Aceptar" AT LINE 24 COL 33.
