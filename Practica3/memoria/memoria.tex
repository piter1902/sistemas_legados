...
\item Pedro Allué Tamargo: Creación de la API REST, organización de la estructura de proyectos, implementación de la clase \emph{Wrapper}, redacción de la memoria.
	...
	\end{itemize}
\item Juan José Tambo Tambo: Implementación de funcionalidades de la \textit{API REST}, búsqueda de mejores \textit{Datasets} para el \textit{OCR} y búsqueda de alternativas al \textit{OCR}. 
\begin{itemize}
	\item Tiempo invertido: 9 horas
\end{itemize}
\item Jesús Villacampa Sagaste: Implementación del frontend del \textit{Wrapper}, búsqueda de alternaticas a \textit{OCR} y redacción de memoria.
	\begin{itemize}
